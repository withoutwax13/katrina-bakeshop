        ...
        return (
            <footer>
                <Container className='text-center'>
                    <Row>
                        <span>Weekdays: 9AM-5PM | Weekend: 9AM-8PM</span>
                    </Row>
                    <Row>
                        <span>Molino RD, Greenfield District Bacoor City, Cavite</span>
                    </Row>
                    <Row>
                        <span>
                            Landline: (212)456-7890
                        </span>
                        <span>
                            Phone Number(Globe): 0916-7006035 | Phone Number(Smart): 0906-9028632
                        </span>
                    </Row>
                    <Row>
            ...
            // <footer className="footer-distributed pt-5 pb-2 container-fluid" style={{marginTop: '40px', backgroundColor: '#CFCFC4'}}>
            ...
            //                 <h4>PAGES</h4>
            //                 <p><a href={`/katrina-bakeshop/`} style={{textDecoration: 'none', color: 'black'}}>Home</a></p> 
            //                 <p><a href={`/katrina-bakeshop/order`} style={{textDecoration: 'none', color: 'black'}}>Order</a></p>
            //                 <p><a href={`/katrina-bakeshop/cart`} style={{textDecoration: 'none', color: 'black'}}>Cart</a></p>
            //                 <p><a href={`/katrina-bakeshop/contact`} style={{textDecoration: 'none', color: 'black'}}>Contact</a></p>
            //             </div>
            //             <div className="col-lg-3">
            //                 <h4>CONTACT INFO</h4>
