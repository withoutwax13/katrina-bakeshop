            ...
            <div className='container d-flex align-items-center justify-content-center' style={{height: `${this.getScreenHeight()}px`}}>
                <div className="container">
                    ...
                    <div className="col-lg-12">
                        <h1 className="text-center pt-3 pb-3">Our Team</h1>
                        <div className='row'>
                            ...
                            <div className='col-10 px-5 py-4' style={{backgroundColor: 'white', boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px, rgb(51, 51, 51) 0px 0px 0px 3px'}}>
                                <p className='text-center'>Our team is composed of friendly, hospitable, and well trained staff for our bakeshop's complex operations. We can asure you that our products are professionally and freshly made with the use of high quality ingredients. We are happy to serve you.</p>
